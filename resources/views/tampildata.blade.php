...
<body>
    <h1 class="text-center mb-5">Edit Data Project Monitoring</h1>
                    ...
                    <div class="card-body">
                        <form action="/updatedata/{{ $data->id }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="project_leader" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $data->project_leader}}">
                            </div>
                            <div class="mb-3">
