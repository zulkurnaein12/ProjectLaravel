...
<body>
    <h1 class="text-center mb-5">Tambah Data Project Monitoring</h1>
                    ...
                    <div class="card-body">
                        <form action="/insertdata" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="project_leader" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" name="progress" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                            </div>
